          ...
          {items.length > 0 && (
            <div className="border-t border-border p-4 flex flex-col gap-3">
              ...
              <button
                ...
                disabled={isPending}
                className="h-11 w-full rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isPending ? (
                  <>
