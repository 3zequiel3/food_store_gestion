...
## Purpose
TBD - created by archiving change frontend-rebuild-on-feature-first. Update Purpose after archive.
## Requirements
...
> Delta from archived change `frontend-rebuild-on-feature-first` (2026-05-12). The following requirements were added by that change and are already reflected above; this section is retained for traceability.
